      ...
      _initIdentifyLayers: function () {
        ...
        for (var e=0; e < len; e++) {
          ...
          options.push(option);
            ...
            ////modifying Identify widget to hijack input if local URL is used!!! ////
          var str = this.config.layers.layer[e].links;
          var n = str.search("\\sinner");
          //if (n >= 0) {
          //    //var inputSpliced = this.linkContentTA.value.splice(0, 20);
          //    //var a = this.linkContentTA.value;
          //    //var b = 'maps.sagis.local';
          //    //var c = b + a;
          //    //this.linkContentTA.value = c;
          //    alert('n greater or equal to 0')
          //    //this.linkContentTA.value.replace('//sinner-1.sagis.local', 'http://saint-2.sagis.local');
          //}
            /////
